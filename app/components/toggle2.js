...
const LocationToggle = () => {
  ...
  return (
    <div className="relative flex gap-2 w-fit p-1 mt-20 rounded-full bg-slate-400">
      <div
      ...
      <button
        ...
        className={`w-20 text-center text-sm z-10 font-semibold transition-colors duration-300 ${
          toggle === 'location' ? 'text-white' : 'text-gray-300'
        }`}
      >
        Location
      </button>
      <button
        ...
        className={`w-20 text-center text-sm z-10 font-semibold transition-colors duration-300 ${
          toggle === 'address' ? 'text-white' : 'text-gray-300'
        }`}
      >
        Address
      </button>
